    ...
    async def push_configuration_params(
        ...
        *,
        ...
        params: list[tuple[str, float]] = [
            ...
            # One-push auto white balance a short settle after each phase's
            # lights come on.
            ("DORIS_DSC_AWB", 1.0 if config.descent.auto_white_balance else 0.0),
            ("DORIS_BTM_AWB", 1.0 if config.bottom.auto_white_balance else 0.0),
            ("DORIS_ASC_AWB", 1.0 if config.ascent.auto_white_balance else 0.0),
